...
template <class ZT, class FT>
double MatGSOInterface<ZT, FT>::return_gh_ratio (int kappa, int block_size)
{
...
template <class ZT, class FT>
double MatGSOInterface<ZT, FT>::compare_gh_ratio (FT &bi, int kappa, int block_size)
{
...
#if 0
template<class ZT, class FT>
inline void MatGSOInterface<ZT, FT>::print_mu(int i, int j) {
...
template<class ZT, class FT>
inline void MatGSOInterface<ZT, FT>::print_mu_matrix() {
  FT f;
  /*
...
template<class ZT, class FT>
void MatGSOInterface<ZT, FT>::check_mu_matrix() {
  FT f;
  ZT z2, z3;
  double fd, fd2;
  int exitflag = 0;
 ...
 */
template<class ZT, class FT>
void MatGSOInterface<ZT, FT>::print_r_matrix() {
  FT f;
 ...
 */
template<class ZT, class FT>
void MatGSOInterface<ZT, FT>::check_r_matrix() {
  FT f, f2;
...
template<class ZT, class FT>
void MatGSOInterface<ZT, FT>::check_g_matrix() {
  FT gg;
  ZT zz;
